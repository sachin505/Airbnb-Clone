...
function Header({placeholder}) {
  ...
  <input type='text' placeholder={placeholder||"Start your Search"} className='pl-5 
  bg-transparent outline-none flex-grow
  text-sm text-gray-600 placeholder-gray-400' value={searchInput} onChange={(e)=>setSearchInput(e.target.value)}/>
